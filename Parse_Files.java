...
public class Parse_Files {
	...
	public Parse_Files(int f, int t){
		sound = 0;
		framenum = f;
		type = t;
	...
	public void readAndextractSound() throws PlayWaveException, FileNotFoundException, IOException{
		...
		if(type == 0)
			soundFileName= "/Users/miloni_134/Desktop/CSCI576/databse_videos/" + videoname + "/" + videoname + ".wav";
		else
			soundFileName= "/Users/miloni_134/Desktop/CSCI576/query/" + videoname + "/" + videoname  + ".wav";
		try {
	...
	public void readAndextractVideo() {
		for(int i = 0;i < framenum;i++) {
			...
			String imgpath;
			if(type == 0)
				imgpath= "/Users/miloni_134/Desktop/CSCI576/databse_videos/"  + videoname + "/" + videoname + "" + num + ".rgb";
			else
				imgpath= "/Users/miloni_134/Desktop/CSCI576/query/" + videoname + "/" + videoname +"" + num + ".rgb";
	...
	private void normalizeVector(int k) {
		...
		double rgbProd = rgbCount[k][0] * rgbCount[k][0] + rgbCount[k][1] * rgbCount[k][1]+ rgbCount[k][2] * rgbCount[k][2];
